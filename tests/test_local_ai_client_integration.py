...
from app.ai_clients.lm_studio import LocalAIClient, LocalAIError
...
class LocalAIClientIntegrationTests(unittest.TestCase):
    def test_generates_structured_output_with_real_lm_studio_model(self):
        client = LocalAIClient(
            ...
            timeout_seconds=int(os.getenv("LOCAL_AI_TIMEOUT_SECONDS", "120")),
        )
